                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-success btn-outline-success">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="collapse" id="collapseExample1">
                        ...
                        Для оформления заказа выберите нужный товар и добавьте его в корзину. После этого перейдите в корзину и следуйте инструкциям оформления заказа, введя необходимую информацию о доставке и оплате.
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="collapseExample2">
                        <div class="card card-body">
                        Мы предлагаем различные способы доставки, включая курьерскую доставку, почтовую службу и пункты выдачи. Выбор доступных методов доставки зависит от вашего местоположения.
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="collapseExample3">
                        <div class="card card-body">
                        Наша гарантия обеспечивает качество товаров и покрывает производственные дефекты и несоответствие описанию в определенный период времени после покупки..
                        </div>
                    </div>
                </div>
                <table class="table">
